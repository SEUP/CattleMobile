                ...
                <StackLayout class="card">
                    <StackLayout class="card-menu bg-blue" style=" " orientation="vertical">
                        ...
                        <StackLayout class="txt-gr">
                            ...
                            <TextField v-model="form.personal_id" hint="รหัสประจำตัวประชาชน" class="gr-text" row="0"
                                col="1" />
                        </StackLayout>
                        ...
                        <StackLayout class="txt-gr">
                            ...
                            <TextField @tap="selectProvince" :text="`จังหวัด ${getProvinceNameByCode(form.house_province) || ''}`"
                                class="gr-text" row="0" col="1" />
                        </StackLayout>
                        ...
                        <StackLayout class="txt-gr">
                            ...
                            <TextField @tap="selectAmphur" :text="`อำเภอ ${getAmphurNameByCode(form.house_province,form.house_amphur) || ''}`"
                                class="gr-text" row="0" col="1" />
                        </StackLayout>
                        ...
                        <StackLayout class="txt-gr">
                            ...
                            <TextField @tap="selectDistrict" :text="`ตำบล ${getDistrictNameByCode(form.house_province,form.house_amphur,form.house_district) || ''}`"
                                class="gr-text" row="0" col="1" />
                        </StackLayout>
                ...
                <StackLayout class="card">
                    <StackLayout class="card-menu bg-blue" style=" " orientation="vertical">
                        ...
                        <StackLayout class="txt-gr">
                            ...
                            <TextField v-model="form.password_confirmation" hint="ยืนนยันรหัสผ่าน" class="gr-text" row="0"
                                col="1" />
                        </StackLayout>
