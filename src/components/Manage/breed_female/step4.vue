        ...
        <StackLayout class="card">
          <StackLayout class="card-menu bg-violet" orientation="vertical">
            ...
            <StackLayout class="txt-gr">
              ...
              <TextField class="gr-text" row="0" col="1" @tap="setDate(form,'reversal_date')" hint="โปรดกรอกข้อมูล"
                :text="`${ form.reversal_date ? $moment(form.reversal_date).format('DD MMMM YYYY') : 'โปรดกรอกข้อมูล'}`" />
            </StackLayout>
            ...
            <StackLayout v-if="form.reversal == '280200'" class="txt-gr">
              <StackLayout class="gr">
                <Label class="gr-label light" text="วัน/เดือน/ปี" row="0" col="0" />
              </StackLayout>
